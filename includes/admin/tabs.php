...
<div id="the-list">
    <div id="horizontalTab">
        <ul class="tabs">
            <li class="tab-link current" data-tab="tab-1">Plugins</li>
        </ul>
   </div>
<?php $dir_url = WP_EASY_CONTACT_PLUGIN_URL; ?>
 <div class="tab-content current"  id="tab-1"><div class="emd-plugin-card" style="width:100%;max-width: 320px;">
	<div class="emd-plugin-card-top" style="">
		...
		<div class="img-caption">
			<img alt="Software Issue Manager" height="200" src="<?php echo $dir_url . 'assets/img/addons/sim-arch-320x200.gif';?>" style="width:100%" title="Software Issue Manager">
			<p class="desc column-description">The Best WordPress<br> Issue and Project Management Plugin</p>
		</div>
	</div>
	...
	<div class="emd-plugin-card-top" style="">
		...
		<div class="img-caption">
			<img alt="WP Ticket" height="200" src="<?php echo $dir_url . 'assets/img/addons/wpticket-arch-320x200.gif';?>" style="width:100%" title="WP Ticket">
			<p class="desc column-description">The Easiest and Most Powerful<br> Customer Support and HelpDesk<br> WordPress Plugin</p>
		</div>
	</div>
	<div class="emd-plugin-card-bottom">
	...
	<div class="emd-plugin-card-top" style="">
		...
		<div class="img-caption">
			<img alt="YouTube Showcase" height="200" src="<?php echo $dir_url . 'assets/img/addons/youtubesc-arch-320x200.gif';?>" style="width:100%" title="YouTube Showcase">
			<p class="desc column-description">The Best WordPress<br> YouTube Video Gallery and Management Plugin</p>
		</div>
	</div>
	<div class="emd-plugin-card-bottom">
	...
	<div class="emd-plugin-card-top" style="">
		...
		<div class="img-caption">
			<img alt="WP Easy Contact" height="200" src="<?php echo $dir_url . 'assets/img/addons/wpcontact-arch-320x200.gif';?>" style="width:100%" title="WP Easy Contact">
			<p class="desc column-description">The Best WordPress<br>Contact Management Plugin</p>
		</div>
	</div>
	<div class="emd-plugin-card-bottom">
	...
	<div class="emd-plugin-card-top" style="">
		...
		<div class="img-caption">
			<img alt="Employee Directory" height="200" src="<?php echo $dir_url . 'assets/img/addons/emddir-arch-300x200.gif';?>" style="width:100%" title="Employee Directory">
			<p class="desc column-description">The Best WordPress<br> Employee Directory Plugin</p>
		</div>
	</div>
	<div class="emd-plugin-card-bottom">
	...
	<div class="emd-plugin-card-top" style="">
		...
		<div class="img-caption">
			<img alt="Employee Spotlight" height="200" src="<?php echo $dir_url . 'assets/img/addons/spotlight-arch-300x200.png';?>" style="width:100%" title="Employee Spotlight">
			<p class="desc column-description">The Most Powerful and Easiest<br> WordPress Team Management Plugin</p>
		</div>
	</div>
	<div class="emd-plugin-card-bottom">
	...
	<div class="emd-plugin-card-top" style="">
		...
		<div class="img-caption">
			<img alt="Knowledge Center" height="200" src="<?php echo $dir_url . 'assets/img/addons/kcenter-arch-300x200.gif';?>" style="width:100%" title="Knowledge Center">
			<p class="desc column-description">The Best WordPress<br> Knowledge Base Management Plugin</p>
		</div>
	</div>
	<div class="emd-plugin-card-bottom">
	...
	<div class="emd-plugin-card-top" style="">
		...
		<div class="img-caption">
			<img alt="WP Easy Events" height="200" src="<?php echo $dir_url . 'assets/img/addons/wpee-arch-300x200.gif';?>" style="width:100%" title="WP Easy Events">
			<p class="desc column-description">The Best<br> WordPress Event Management<br>and Ticketing Plugin</p>
		</div>
	</div>
	<div class="emd-plugin-card-bottom">
	...
	<div class="emd-plugin-card-top" style="">
		...
		<div class="img-caption">
			<img alt="Campus Directory" height="200" src="<?php echo $dir_url . 'assets/img/addons/campusdir-arch-300x200.png';?>" style="width:100%" title="Campus Directory">
			<p class="desc column-description">The Best WordPress Campus Directory Solution<br>for Higher Education Institutions</p>
		</div>
	</div>
	<div class="emd-plugin-card-bottom">
	...
	<div class="emd-plugin-card-top" style="">
		...
		<div class="img-caption">
			<img alt="Request a quote" height="200" src="<?php echo $dir_url . 'assets/img/addons/request-a-quote-arch-320x200.gif';?>" style="width:100%" title="Request a quote">
			<p class="desc column-description">The Best Quoting Software<br>for WordPress</p>
		</div>
	</div>
	<div class="emd-plugin-card-bottom">
